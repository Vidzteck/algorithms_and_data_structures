...
#Размер покрытия: 8
#Покрытие: [0, 1, 3, 4, 6, 7, 8, 9]
#Все ребра покрыты ✓
#Размер оптимального покрытия (известный): 5
#Коэффициент аппроксимации (A(I) / OPT(I)): 1.60
#Коэффициент гарантированной 2-аппроксимации: <= 2
#Коэффициент аппроксимации соответствует гарантии (≤ 2). ✓
